...
/*
 * the urlPattren takes the values from the order html page, which is the value
 * of action in the fomr tag
 */
public class OrderDetails extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 * 
		 * String customerName = req.getParameter("customerName"); String items =
		 * req.getParameter("items"); String quantity = req.getParameter("quantity");
		 * 
