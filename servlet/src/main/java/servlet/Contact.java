...
public class Contact extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
		 * PrintWriter printWriter = resp.getWriter(); String employeeNAme =
		 * req.getParameter("employeeNAme"); String emailId =
		 * req.getParameter("emailId"); String phoneNumber =
		 * req.getParameter("phoneNumber"); String age = req.getParameter("age");
		 * 
