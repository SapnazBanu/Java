package com.xworkz.lombokproject.Runner;
...
public class EmailRunner {
	...
	public static void main(String[] args) {
		...
		EmailDTO email = new EmailDTO("xworkz@gmail.com", "sapna@gmail.com", "Mock Remainder",
				"Don't forget about your mock at 10AM");
		EmailDTO email2 = new EmailDTO("xworkz@gmail.com", "viji@gmail.com", "Mock Remainder",
				"Don't forget about your mock at 11AM");
		EmailDTO email3 = new EmailDTO("xworkz@gmail.com", "ani@gmail.com", "Birthday wishes",
				"Many more happy returns of the deepak");
		EmailDTO email4 = new EmailDTO("xworkz@gmail.com", "megh@gmail.com", "Project Update",
				"The project is on track for delivery");
		EmailDTO email5 = new EmailDTO("chethan@gmail.com", "sanju@gmail.com", "Birthday Invitation",
